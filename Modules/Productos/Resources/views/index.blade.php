...
@section('breadcumb')
  <div class="d-flex align-items-center flex-wrap mr-2">
    ...
    <span class="text-muted font-weight-bold mr-4">Todas los productos</span>
  </div>
@endsection
@section('content')
  <div class="row">
      ...
      <div class="card card-custom">
          <div class="card-header">
            <div class="card-title">
              ...
              <h3 class="card-label">Todas los productos</h3>
            </div>
            <div class="card-toolbar">
              <a href="/productos/create" class="btn btn-primary font-weight-bolder">
  ...
  $(function() {
    tabla = $('#kt_datatable').DataTable({
      ...
      columns: [
        ...
        { data: 'pesoPromedio', name: 'pesoPromedio' },
