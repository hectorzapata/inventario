...
@section('breadcumb')
  <div class="d-flex align-items-center flex-wrap mr-2">
    ...
    <span class="text-muted font-weight-bold mr-4">Todos los principales</span>
  </div>
@endsection
@section('content')
  <div class="row">
      ...
      <div class="card card-custom">
          <div class="card-header">
            <div class="card-title">
              ...
              <h3 class="card-label">Todos los principales</h3>
            </div>
            <div class="card-toolbar">
              <a href="/principales/create" class="btn btn-primary font-weight-bolder">
