...
@section('breadcumb')
  <div class="d-flex align-items-center flex-wrap mr-2">
    ...
    <span class="text-muted font-weight-bold mr-4">Todo el equipo médico</span>
  </div>
@endsection
@section('content')
  <div class="row">
      ...
      <div class="card card-custom">
          <div class="card-header">
            <div class="card-title">
              ...
              <h3 class="card-label">Todo el equipo médico</h3>
            </div>
            <div class="card-toolbar">
              <a href="/equipomedico/create" class="btn btn-primary font-weight-bolder">
